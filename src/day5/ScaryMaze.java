...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		java.applet.AudioClip sound = JApplet.newAudioClip(getClass().getResource("lop.wav"));
	...
	private void showScaryImage(String scarypic) {
		try {
			maze = ImageIO.read(getClass().getResource(scarypic));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + scarypic);
		}
		repaint();
	}
