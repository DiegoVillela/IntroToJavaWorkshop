...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		speak("Spell 87573");
		String op = JOptionPane.showInputDialog("Spell 87573");
		// 2. Catch the user's answer in a String
		String lol = "Eighty_Seven_Thousand_Five_Hundred_Seventy_Three";

		// 3. If the user spelled the word correctly, speak "correct"
		if (lol.equals("Eighty_Seven_Thousand_Five_Hundred_Seventy_Three"))
